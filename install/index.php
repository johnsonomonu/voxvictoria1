...
if ($action == 'result') {
	...
	if (@$response['error'] == 'ok' && $db instanceof PDO) {
		try {
	...
	<header class="py-3 border-bottom border-primary bg--dark">
		<div class="container">
			<div class="d-flex align-items-center justify-content-between header gap-3">
				...
				<h3 class="title">Easy Installer | <a style="color:red;" href="https://weadown.com" target="_blank">weadown.com</a></h3>
			</div>
		</div>
	</header>
